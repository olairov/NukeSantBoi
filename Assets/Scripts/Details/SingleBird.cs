...
public class SingleBird : MonoBehaviour
{
    ...
    void Initialize()
    {
        ...
        float distance = Random.Range(0.15f, 0.4f); // Smaller the "distance" value, further away the bird will be. (sorry)

        transform.localScale = transform.localScale * distance * 3;
