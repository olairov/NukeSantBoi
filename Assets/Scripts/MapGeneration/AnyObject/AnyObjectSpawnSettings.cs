...
public class AnyObjectSpawnSettings : ScriptableObject
{
    public float timeIntervalMin, timeIntervalMax, firstGenMinDistance, firstGenMaxDistance,
        firstGenMinDistFromRightBorder, firstGenMaxDistFromRightBorder, firstGenDistFromLeftBorder, yMin, yMax, zMin, zMax, xMin, xMax;
    public bool appearingObject, onlyFirstGeneration, firstGenIsOnlyManual;
